...
// ✅ NEW: Handle quiz answer submissions
document.getElementById("submit-answer").addEventListener("click", async () => {
    const answer = document.getElementById("quiz-answer").value;
    const mode = document.getElementById("subject").value;
    ...
    if (data.next_question) {
        quizQuestionDiv.innerHTML = `<strong>Quiz Question:</strong> ${data.next_question}`;
        document.getElementById("quiz-answer").value = "";
    }

    if (data.final) {
        quizQuestionDiv.innerHTML = `<strong>${data.final}</strong>`;
